...
async function linkedinData(linkedinURL, page) {
...
async function certData(certURL, page) {
...
async function skillsData(skillsURL, page) {
...
async function start() {
	...
	try {
		...
		// Promise.resolve()
		// 	.then(() => {
		// 		return linkedinData(linkedinURL, page);
		// 	})
		// 	.then(() => {
		// 		return certData(certURL, page);
		// 	})
		// 	.then(() => {
		// 		return skillsData(skillsURL, page);
		// 	})
